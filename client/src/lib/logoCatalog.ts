...
const footballTeamImages: Record<FootballTeamLogoId, string> = {
  "400": footballAtlantaFalcons,
  "401": footballBaltimoreRavens,
  "402": footballBuffaloBills,
  "403": footballCarolinaPanthers,
  "404": footballChicagoBears,
  "405": footballCincinnatiBengals,
  "406": footballClevelandBrowns,
  "407": footballDallasCowboys,
  "408": footballDetroitLions,
  "409": footballGreenBayPackers,
  "410": footballIndianapolisColts,
  "411": footballJacksonvilleJaguars,
  "412": footballKansasCityChiefs,
  "413": footballLosAngelesChargers,
  "414": footballLosAngelesRams,
  "415": footballMiamiDolphins,
  "416": footballMinnesotaVikings,
  "417": footballNewEnglandPatriots,
  "418": footballNewOrleansSaints,
  "419": footballNewYorkGiants,
  "420": footballNewYorkJets,
  "421": footballPhiladelphiaEagles,
  "422": footballPittsburghSteelers,
  "423": footballRaidersLegacy,
  "424": footballSanFrancisco49ers,
  "425": footballSeattleSeahawks,
  "426": footballTampaBayBuccaneers,
  "427": footballWashingtonCommanders,
};
...
export const allLogos: Record<string, LogoEntry> = {
  // Royalty Badge of Honor — 100 series
  ...
  // Football Teams Sports Edition — 400 series (spread below via footballTeamLogos)
  // Compass Collection — 500 series
  "500": { src: compassKKApparel, alt: "Khomplete Khemistri Apparel Compass", color: "KK Apparel Compass", section: "Compass Collection" },
  "501": { src: compassKMG1, alt: "KKMG LLC Compass", color: "KKMG LLC Compass", section: "Compass Collection" },
  "502": { src: compassKMG2, alt: "KKMG LLC Compass II", color: "KKMG LLC Compass II", section: "Compass Collection" },
  "503": { src: compassSunburst, alt: "Khomplete Khemistri Apparel Sunburst Emblem", color: "Apparel Sunburst", section: "Compass Collection" },
  ...footballTeamLogos,
};
