        ...
        <section className="py-24 bg-secondary text-secondary-foreground">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            ...
            <p className="text-lg text-secondary-foreground/80 mb-10 leading-relaxed">
              The Consolidatus Empire represents more than just commerce; it's about ownership, creativity, and self-determination. From Khomplete Khemistri Apparel to our creative studios, we are building a legacy.
            </p>
            <Link href="/studio">
